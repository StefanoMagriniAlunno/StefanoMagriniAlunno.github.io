...
<div class="accordion" id="accordion-events">
  <div class="accordion-item">
    ...
    <div id="collapse3" class="accordion-collapse collapse show" aria-labelledby="heading3" data-bs-parent="#accordion-events", style="">
      <div class="accordion-body">
        <center>
        <strong>2026, Trieste (Italy)</strong><br>
        <img src="./assets/about_3_smr422226.jpg" alt="event photo" class="card-img-top profile-photo-fit"><br> 
        <b>Lecturers:</b><br>
            Andrea Montanari<br>
            Basil Saeed<br>
            Davide Ghio<br>
        ...
        <hr>
        <b>WebPage:</b><br><a href=https://indico.ictp.it/event/11148>https://indico.ictp.it/event/11148</a>
        </center>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#accordion-events", style="">
      <div class="accordion-body">
        <center>
        <strong>2026, Pesaro (Italy)</strong><br>
        <img src="./assets/about_2_MMKT26.jpg" alt="event photo" class="card-img-top profile-photo-fit"><br> 
        <b>Lecturers:</b><br>
            François Golse<br>
            ...
            Lorenzo Pareschi<br>
        <hr>
        <b>WebPage:</b><br><a href=https://mat521.unime.it/~webmama/MMKT/enter.php>https://mat521.unime.it/~webmama/MMKT/enter.php</a>
        </center>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapse1" class="accordion-collapse collapse" aria-labelledby="heading1" data-bs-parent="#accordion-events", style="">
      <div class="accordion-body">
        ...
        <img src="./assets/about_1_MFML26.jpg" alt="event photo" class="card-img-top profile-photo-fit"><br>
        <b>Lecturers:</b><br>
            Lénaïc Chizat<br>
            ...
            Enrique Zuazua<br>
        <hr>
        <b>WebPage:</b><br><a href=https://sites.google.com/unitn.it/mfml-2026/>https://sites.google.com/unitn.it/mfml-2026/</a>
        </center>
      </div>
    </div>
  </div>
